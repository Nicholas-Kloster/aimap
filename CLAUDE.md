...
**43 service fingerprints + 30 deep enumerators** (as of v1.x — see `CHANGELOG.md`).
...
fingerprints.go      # 43 service fingerprints + matcher engine (matchFingerprints, evalMatch)
