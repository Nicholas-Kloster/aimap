...
**56 service fingerprints + 33 deep enumerators** (as of v1.x — see `CHANGELOG.md`).
...
fingerprints.go      # 56 service fingerprints + matcher engine (matchFingerprints, evalMatch)
